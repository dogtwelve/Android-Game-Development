...
public class GLES20anim2D extends Activity {
...
//get max texture Size
   ...
   //check if posx is going out ofscreen
   		...
   		if(posx<0){velx=200;}if(posx>800){velx=-200;}
   		...
   		//animate(animation,direction from velocity,time)
   		animate(walk,velx==200,deltaTime);   		
