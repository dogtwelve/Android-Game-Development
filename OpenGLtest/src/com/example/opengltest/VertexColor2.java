...
public class VertexColor2 extends Activity{
...
class myRenderer implements Renderer {
	...
	float TriangleColor[]={
			1.0f,0.0f,0.0f,1.0f,  	//V1Red,V1Green,V1Blue,V1Alpha
			0.0f,1.0f,0.0f,1.0f,	// V2Red,V2Green,V2Blue,V2Alpha
			0.0f,0.0f,1.0f,1.0f,	//V3Red,V3Green,V3Blue,V3Alpha
			1.0f,1.0f,1.0f,1.0f	// V4Red,V4Green,V4Blue,V4Alpha
			};
...
ShortBuffer index;
	...
	public myRenderer(){
		...
		//4 vertices*2 members(x,y) *4bytes each float
		...
		byteBuffer = ByteBuffer.allocateDirect(4*4*4);
		//4 vertices*4 members(r,g,b,a) *4bytes each float
		byteBuffer.order(ByteOrder.nativeOrder());//set byteorder
		colors = byteBuffer.asFloatBuffer();//colors as floatbuffer
		colors.put(TriangleColor);//copy float array to float buffer
